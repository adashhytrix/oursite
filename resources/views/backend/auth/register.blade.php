              ...
              <div class="card-body px-5 py-5">
                ...
                <form action="{{ route('admin.registerstore')}}" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="username" class="form-control p_input" placeholder="user name" value="{{old('username')}}">
                    @error('username')
                ...
                @enderror
                  ...
                  <div class="form-group">
                    <label>Email</label>
                    <input type="email" name="email"  class="form-control p_input" placeholder="email id" value="{{old('email')}}">
                    @error('email')
                    <span class="text-danger">  {{ $message }}</span>
                @enderror
                  </div>
                ...
                @enderror
                  ...
                  <div class="form-group">
                    <label>Password</label>
                    <input type="password" name="password_confirmation"  class="form-control p_input" placeholder="*********">
