        ...
        <nav id="navigation" class="navigation navigation-landscape">
            ...
            <div class="nav-menus-wrapper" style="transition-property: none;">
                <ul class="nav-menu">
                    ...
                    <li ><a href="{{route('home')}}" class="{{Route::currentRouteName() ==='home' ? 'text-danger' : ''}}">Home
...
{{-- 
                    ...
                    <li ><a href="{{route('about')}}" class="{{Route::currentRouteName() ==='about' ? 'text-danger' : ''}}">About</a></li>
                    <li ><a href="{{route('services')}}" class="{{Route::currentRouteName() ==='services' ? 'text-danger' : ''}}">Services</a></li>
                    <li ><a href="{{route('contact_us')}}" class="{{Route::currentRouteName() ==='contact_us' ? 'text-danger' : ''}}">Contact us</a></li>
                    {{-- <li><a href="documantion/index.html" target="_blank">About</a></li> --}}
